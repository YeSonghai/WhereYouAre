...
#import "LYClassViewControllerTests.h"

@implementation LYClassViewControllerTests
- (void)setUp
{
    [super setUp];
...
- (void) testInitMainTopbar
{
    ...
    STAssertNotNild(self.mMainVC.mainTopBarView, @"mainTopBarView Init fall");
}
